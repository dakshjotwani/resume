...
\item
	...
	\begin{itemize}
		...
		\resitem{Relevant completed courses: Systems Programming, Data Structures and Algorithms, Databases, Computer Architecture, C Programming, Advanced Linear Algebra, Differential Equations.}
	\end{itemize}
...
\begin{description}
\item[Languages:] C, C++, Python, Java, JavaScript, MATLAB.
\item[Frameworks:] React, Numpy.
\item[Softwares/Systems]: Unix, Linux, Git, Vim, Tmux, LaTeX.
\end{description}
