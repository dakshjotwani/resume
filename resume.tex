...
\item
	...
	\begin{itemize}
            ...
            \resitem{Building person reidentification (ReID) and human action detection models to automatically generate receipts for Flipkart and Myntra's offline stores.}
	\end{itemize}
\end{itemize}
