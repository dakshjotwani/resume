...
\item
	...
	\begin{itemize}
        \resitem{Built an OTA update system for Tesla's industrial energy products (Powerpacks and Superchargers) from CentOS to Tesla's proprietary OS.}
        \resitem{Wrote a TLS/websocket client in C for an unannounced product to communicate with Tesla's remote command and logging services.}
	\end{itemize}
\end{itemize}
...
\item
    ...
    \begin{itemize}
            ...
            \resitem{Working on pre-training the ResNet50 backbone on the COCO dataset using RetinaNet and Focal Loss.}
    \end{itemize}
