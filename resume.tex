...
\item
    ...
    \begin{itemize}
            \resitem{Research the impact of speculative region-prioritization on search times for data-points in overlapping regions of an R*-tree. Based on \textit{The Case For Learned Index Structures} (arxiv.org/abs/1712.01208).}
        \resitem{Explore logistic regression and neural network models to speculate traversal routes of an R*-tree.}
    \end{itemize}
\end{itemize}
