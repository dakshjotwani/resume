...
\item
	...
	\ressubheadingb{B.S. Computer Science Honors, B.S. Mathematics}{Aug. 2016 - Present}
	\begin{itemize}
...
\item
    ...
    \ressubheadingb{Undergraduate Research Assistant}{Sept 2018 - Present}
    \begin{itemize}
        \resitem{Exploring deep learning-based techniques to reduce search times for data-points in overlapping ranges of an R*-tree.}
    \end{itemize}
\end{itemize}
