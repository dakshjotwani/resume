...
\item
	...
	\ressubheadingb{B.S. and M.S. Computer Science, B.S. Mathematics}{August 2016 - Present}
	\begin{itemize}
		\resitem{GPA: \textbf{3.94/4.00}, Expected Graduation Date: \textbf{Bachelors: May 2020, Masters: May 2021}}
...
\item
	...
	\ressubheadingb{Data Scientist Intern}{May 2019 - Present}
	\begin{itemize}
            ...
            \resitem{Building person reidentification (ReID) and human action detection models to automatically generate shopping cart receipts for Flipkart and Myntra's offline stores.}
	\end{itemize}
\end{itemize}
...
\item
    \ressubheadinga{Purdue University}{West Lafayette, IN}
    \ressubheadingb{Undergraduate Research Assistant}{September 2018 - December 2018}
    \begin{itemize}
...
\item
    ...
    \begin{itemize}
        \resitem{Teach and grade labs for a \emph{Systems Programming} class that covers operating systems fundamentals.}
            \resitem{Held weekly office hours for a \textit{Systems Programming} and \textit{Electricity and Magnetism} course.}
    \end{itemize}
\end{itemize}
